...
* InfluencerOutput_2.txt)
*/
@Hint("The main method is not working properly with the input file from the
instructions")
...
+ testResultSplit[0]
+ "make sure there's also a ': ' between label and
number");
}
...
@Hint("The main method is not working properly with a the input file provided
in instructions")
